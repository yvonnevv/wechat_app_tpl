...
exports.URL = 'http://521.58801hn.com/';
...
const API_PREFIX = 'https://pan.baidu.com';
exports.PAN_API = {
    verify: `${API_PREFIX}/share/verify`,
    shorturlinfo: `${API_PREFIX}/api/shorturlinfo`,
    list: `${API_PREFIX}/share/list`,
    filelist: `${API_PREFIX}/rest/2.0/xpan/file?method=list`,
    search: `${API_PREFIX}/rest/2.0/xpan/file?method=search`,
    transfer: `${API_PREFIX}/share/transfer`,
    rename: `${API_PREFIX}/rest/2.0/xpan/file`,
    share: `${API_PREFIX}/share/set`
}
